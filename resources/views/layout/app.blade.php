...
<head>
    ...
    <title>BBMS - Blood Bank System</title>
<link  rel="shortcut icon" type="image/x-icon" href="{{ asset('asset/img/b.png') }}">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">BBMS <sup>life save</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('city') }}">Add City</a>
